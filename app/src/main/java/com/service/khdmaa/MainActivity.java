...
import com.service.khdmaa.ui.common.NavigationController;
...
public class MainActivity extends PSAppCompactActivity {
    ...
    public String selectedLocationTownshipId, selectedLocationTownshipName;
    private String loginUserId;
    private String locationId;
    private String locationName;
    private String locationTownshipId;
    private String locationTownshipName;
    ...
    private ItemParameterHolder recentItemParameterHolder = new ItemParameterHolder().getRecentItem();
    private ItemParameterHolder popularItemParameterHolder = new ItemParameterHolder().getPopularItem();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( MainActivity.this != null) {
            ...
            FirebaseDynamicLinks.getInstance()
                    .getDynamicLink( MainActivity.this.getIntent())
...
//                                deepLink = pendingDynamicLinkData.getLink();
                                ...
                                String[] deepLink = pendingDynamicLinkData.getLink().toString().split("=");

                                itemId = deepLink[1];

                                if(itemId !=null && !itemId.isEmpty() ){
                                    navigationController.navigateToItemDetailActivity(MainActivity.this ,itemId);
                                }
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if(fragment != null)
            {
                if(fragment instanceof SelectedCityFragment)
                {
                    ...
                    navigationController.navigateToHome(MainActivity.this, false, selectedLocationId, selectedLocationName, selectedLocationTownshipId, selectedLocationTownshipName, false);
        ...
        binding.addItemButton.setOnClickListener(v -> {
            ...
            Utils.navigateOnUserVerificationActivity(userIdToVerify, loginUserId, psDialogMsg, this, navigationController, () -> {
                try {
                    ...
                    locationTownshipId = pref.getString(Constants.SELECTED_TOWNSHIP_ID, Constants.EMPTY_STRING);
                    locationTownshipName = pref.getString(Constants.SELECTED_TOWNSHIP_NAME, Constants.EMPTY_STRING);
                ...
                navigationController.navigateToItemEntryActivity(MainActivity.this, Constants.ADD_NEW_ITEM, locationId, locationName, locationTownshipId, locationTownshipName);
    ...
    private void getIntentData() {
        ...
        selectedLocationTownshipId = getIntent().getStringExtra(Constants.SELECTED_TOWNSHIP_ID);
        selectedLocationTownshipName = getIntent().getStringExtra(Constants.SELECTED_TOWNSHIP_NAME);
        ...
        pref.edit().putString(Constants.SELECTED_TOWNSHIP_ID, selectedLocationTownshipId).apply();
        pref.edit().putString(Constants.SELECTED_TOWNSHIP_NAME, selectedLocationTownshipName).apply();
    ...
    private void openFragment(int menuId) {
        ...
        switch (menuId) {
            ...
            case R.id.nav_home_login:
                ...
                setToolbarText(binding.toolbar, Constants.EMPTY_STRING);
                navigationController.navigateToHome(this, false, selectedLocationId, selectedLocationName, selectedLocationTownshipId, selectedLocationTownshipName, false);
                showBottomNavigation();
                break;
            ...
            case R.id.nav_latest_login:
                ...
                recentItemParameterHolder.location_id = selectedLocationId;
                recentItemParameterHolder.location_township_id = selectedLocationTownshipId;
                navigationController.navigateToHomeLatestFiltering(MainActivity.this, recentItemParameterHolder);
                hideBottomNavigation();
                break;
            ...
            case R.id.nav_popular_login:
                ...
                popularItemParameterHolder.location_id = selectedLocationId;
                popularItemParameterHolder.location_township_id = selectedLocationTownshipId;
                navigationController.navigateToHomePopularFiltering(MainActivity.this, popularItemParameterHolder);
                hideBottomNavigation();
                break;
...
//                hideBottomNavigation();
    ...
    private void initData() {
        ...
        userViewModel.getLoginUser().observe(this, data -> {
            ...
            if (isLogout) {
                navigationController.navigateToHome(MainActivity.this, false, selectedLocationId, selectedLocationName, selectedLocationTownshipId, selectedLocationTownshipName, true);
                showBottomNavigation();
                refreshUserData();
                isLogout = false;
