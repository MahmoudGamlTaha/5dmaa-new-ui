package com.service.khdmaa.ui.item.search.specialfilterbyattributes;
...
import com.service.khdmaa.databinding.FragmentFilterBinding;
...
public class FilteringFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private final String currencyId = Constants.EMPTY_STRING;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE__SEARCH_VIEW_FRAGMENT && resultCode == Constants.RESULT_CODE__SEARCH_WITH_ITEM_LOCATION_TYPE) {
