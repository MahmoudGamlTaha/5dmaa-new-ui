package com.service.khdmaa.ui.category.categoryfilter;
...
import com.service.khdmaa.databinding.TypeFilterBinding;
import com.service.khdmaa.ui.category.adapter.CategoryFilterAdapter;
...
//                int lastPosition = absListView.getLastVisiblePosition();
                ...
                if (firstVisibleItem + visibleItemCount == totalItemCount ) {
                    ...
                    if (!binding.get().getLoadingMore() && !itemCategoryViewModel.forceEndLoading) {
                        ...
                        itemCategoryViewModel.setNextPageLoadingStateObj(Utils.checkUserId(loginUserId), String.valueOf(limit), String.valueOf(itemCategoryViewModel.offset), itemCategoryViewModel.categoryParameterHolder);
        ...
        binding.get().swipeRefresh.setOnRefreshListener(() -> {
            ...
            // update live data
            itemCategoryViewModel.setCategoryListObj(Utils.checkUserId(loginUserId), String.valueOf(Config.LIST_FILTER_CATEGORY_COUNT), String.valueOf(itemCategoryViewModel.offset), itemCategoryViewModel.categoryParameterHolder);
    ...
    private void initializeAdapter() {
        CategoryFilterAdapter nvAdapter = new CategoryFilterAdapter(dataBindingComponent, new CategoryFilterAdapter.filteringClickCallback() {
            @Override
            public void onClick(String catId, String subCatId) {
