...
import com.service.khdmaa.di.Injectable;
...
public abstract class PSFragment extends Fragment implements Injectable {
    ...
    protected String selected_township_id, selected_township_name;

    protected String userEmailToVerify, userPasswordToVerify, userNameToVerify, userIdToVerify;

    protected String defaultCurrencyId, defaultCurrency;
    ...
    protected void loadLoginUserId() {
        try {
            ...
            if (getActivity() != null && getActivity().getBaseContext() != null) {
                ...
                selected_township_id = pref.getString(Constants.SELECTED_TOWNSHIP_ID, Constants.EMPTY_STRING);
                selected_township_name = pref.getString(Constants.SELECTED_TOWNSHIP_NAME, Constants.EMPTY_STRING);
                ...
                defaultCurrencyId = pref.getString(Constants.DEFAULT_CURRENCY_ID, Constants.EMPTY_STRING);
                defaultCurrency = pref.getString(Constants.DEFAULT_CURRENCY, Constants.EMPTY_STRING);
