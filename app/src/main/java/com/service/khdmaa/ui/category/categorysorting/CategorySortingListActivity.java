package com.service.khdmaa.ui.category.categorysorting;
...
import com.service.khdmaa.databinding.ActivityCategoryListBinding;
...
public class CategorySortingListActivity extends PSAppCompactActivity {
    ...
    private void initUI(ActivityCategoryListBinding binding) {
        ...
        setupFragment(new CategorySortingListFragment());
