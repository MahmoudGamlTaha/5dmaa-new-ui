package com.service.khdmaa.ui.city.selectedcity;
...
import com.service.khdmaa.databinding.FragmentSelectedCityBinding;
import com.service.khdmaa.ui.category.adapter.CityCategoryAdapter;
import com.service.khdmaa.ui.common.DataBoundListAdapter;
import com.service.khdmaa.ui.common.PSFragment;
import com.service.khdmaa.ui.dashboard.adapter.DashBoardViewPagerAdapter;
import com.service.khdmaa.ui.item.adapter.ItemHorizontalListAdapter;
...
//    private ClearAllDataViewModel clearAllDataViewModel;
    ...
    protected void initUIAndActions() {
     ...
     ///       binding.get().adView2.loadAd(adRequest2);
        ...
        binding.get().categoryViewAllTextView.setOnClickListener(v -> navigationController.navigateToCategorySortingActivity(getActivity()));
        ...
        binding.get().addItemButton.setOnClickListener(v -> {
            ...
            Utils.navigateOnUserVerificationActivity(userIdToVerify, loginUserId, psDialogMsg, getActivity(), navigationController, new Utils.NavigateOnUserVerificationActivityCallback() {
                ...
                public void onSuccess() {
                    navigationController.navigateToItemEntryActivity(SelectedCityFragment.this.getActivity(), Constants.ADD_NEW_ITEM, recentItemViewModel.locationId, recentItemViewModel.locationName, recentItemViewModel.locationTownshipId,  recentItemViewModel.locationTownshipName);
                }
            });
...
//        });
        ...
        binding.get().swipeRefresh.setOnRefreshListener(() -> {
            ...
            // update live data
            itemCategoryViewModel.setCategoryListObj(Utils.checkUserId(loginUserId), String.valueOf(Config.LIST_CATEGORY_COUNT), String.valueOf(itemCategoryViewModel.offset), recentItemViewModel.categoryParameterHolder);
...
//        });
    ...
    private void getIntentData() {
        ...
        if (getActivity() != null) {
            ...
            recentItemViewModel.locationTownshipId = selected_township_id;
            recentItemViewModel.locationTownshipName = selected_township_name;
            ...
            recentItemViewModel.recentItemParameterHolder.location_township_id = recentItemViewModel.locationTownshipId;
            popularItemViewModel.popularItemParameterHolder.location_township_id = recentItemViewModel.locationTownshipId;
            featuredItemViewModel.featuredItemParameterHolder.location_township_id = recentItemViewModel.locationTownshipId;
            searchItemParameterHolder.location_township_id = recentItemViewModel.locationTownshipId;

            if(Config.ENABLE_SUB_LOCATION) {

                if(!recentItemViewModel.locationTownshipName.equals("")) {
                    binding.get().locationTextView.setText(recentItemViewModel.locationTownshipName);
                }else {
                    binding.get().locationTextView.setText( selected_location_name);
                }
    ...
    private void loadProducts() {
        ...
        itemCategoryViewModel.setCategoryListObj(Utils.checkUserId(loginUserId), String.valueOf(Config.LIST_CATEGORY_COUNT), Constants.ZERO, itemCategoryViewModel.categoryParameterHolder);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null) {
            if (requestCode == Constants.REQUEST_CODE__SELECTED_CITY_FRAGMENT
                ...
                recentItemViewModel.locationTownshipId = data.getStringExtra(Constants.ITEM_TOWNSHIP_TYPE_ID);
                recentItemViewModel.locationTownshipName = data.getStringExtra(Constants.ITEM_TOWNSHIP_TYPE_NAME);
                ...
                pref.edit().putString(Constants.SELECTED_TOWNSHIP_ID, recentItemViewModel.locationTownshipId).apply();
                pref.edit().putString(Constants.SELECTED_TOWNSHIP_NAME, recentItemViewModel.locationTownshipName).apply();
                ...
                if (getActivity() != null) {
                    ...
                    navigationController.navigateToHome((MainActivity) getActivity(), true, recentItemViewModel.locationId,
                            recentItemViewModel.locationName, recentItemViewModel.locationTownshipId, recentItemViewModel.locationTownshipName, false);
                }
