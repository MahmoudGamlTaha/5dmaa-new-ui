package com.service.khdmaa.ui.item.entry;
...
import com.service.khdmaa.databinding.FragmentItemEntryBinding;
import com.service.khdmaa.databinding.ItemEntryBottomBoxBinding;
...
import com.service.khdmaa.utils.paths.RealPathUtil;
            ...
            if ((itemViewModel.firstImagePath.equals("") && firstImageId.equals(""))
                ...
                if (itemViewModel.itemId != null) {
                    if (!itemViewModel.itemId.equals(Constants.ADD_NEW_ITEM)) {//edit
                        ...
                        itemViewModel.setUploadItemObj(ItemEntryFragment.this.catId, ItemEntryFragment.this.subCatId, ItemEntryFragment.this.typeId, ItemEntryFragment.this.priceTypeId, defaultCurrencyId, ItemEntryFragment.this.conditionId, ItemEntryFragment.this.locationId, ItemEntryFragment.this.locationTownshipId,
