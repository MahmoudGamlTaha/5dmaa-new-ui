...
import com.service.khdmaa.databinding.FragmentSearchCategoryBinding;
import com.service.khdmaa.ui.category.adapter.SearchCategoryAdapter;
...
public class DashBoardSearchCategoryFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface{
    ...
    protected void initUIAndActions() {
        ...
        binding.get().swipeRefresh.setOnRefreshListener(() -> {
            ...
            // update live data
            itemCategoryViewModel.setCategoryListObj(Utils.checkUserId(loginUserId), String.valueOf(Config.LIST_SEARCH_CATEGORY_COUNT), String.valueOf(itemCategoryViewModel.offset), itemCategoryViewModel.categoryParameterHolder);
    ...
    private void loadCategory() {
        ...
        itemCategoryViewModel.setCategoryListObj(Utils.checkUserId(loginUserId),"", String.valueOf(itemCategoryViewModel.offset), itemCategoryViewModel.categoryParameterHolder);
