package com.service.khdmaa.ui.item.itemtownshiplocation.townshipLocationFilter;
...
import com.service.khdmaa.databinding.FragmentItemTownshipLocationFilterBinding;
...
public class ItemTownshipLocationFilterFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {

    private final androidx.databinding.DataBindingComponent dataBindingComponent = new FragmentDataBindingComponent(this);
    private ItemTownshipLocationViewModel itemLocationViewModel;
    public Intent intent = new Intent();
    private ItemTownshipLocation itemLocation;
    private boolean searchKeywordOnFocus = false;

    @VisibleForTesting
    private AutoClearedValue<FragmentItemTownshipLocationFilterBinding> binding;
    private AutoClearedValue<List<ItemTownshipLocation>> lastItemLocationData;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        FragmentItemTownshipLocationFilterBinding dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_item_township_location_filter, container, false, dataBindingComponent);
    ...
    protected void initUIAndActions() {
        ...
        binding.get().filterButton.setOnClickListener(v -> {
            ...
            if (getActivity() != null) {
                navigationController.navigateBackToItemTownshipLocationFilterFragment(getActivity(),
