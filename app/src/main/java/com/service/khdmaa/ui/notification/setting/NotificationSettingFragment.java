package com.service.khdmaa.ui.notification.setting;
...
import com.service.khdmaa.databinding.FragmentNotificationSettingBinding;
            ...
            if (notificationViewModel.pushNotificationSetting != setting) {
                ...
                if (setting) {
                    FirebaseMessaging.getInstance().getToken().addOnCompleteListener(task -> {
                        ...
                        String devicve_token = "";
                        // Get new Instance ID token
                        if (task.getResult() != null) {
                            devicve_token = task.getResult();
                        }

                        notificationViewModel.registerNotification(getContext(), Constants.PLATFORM, devicve_token,loginUserId);
                    });
