package com.service.khdmaa.ui.item.promote.adapter;
...
import com.service.khdmaa.databinding.ItemPromoteHorizontalWithUserBinding;
import com.service.khdmaa.ui.common.DataBoundListAdapter;
import com.service.khdmaa.ui.common.DataBoundViewHolder;
...
public class ItemPromoteHorizontalListAdapter  extends DataBoundListAdapter<ItemPaidHistory, ItemPromoteHorizontalWithUserBinding> {
    ...
    protected boolean areItemsTheSame(ItemPaidHistory oldItem, ItemPaidHistory newItem) {
        return Objects.equals(oldItem.id, newItem.id)
                ...
                && oldItem.item.user.userName.equals(newItem.item.user.userName);
    }
