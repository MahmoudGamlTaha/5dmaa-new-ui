package com.service.khdmaa.ui.stripe;
...
import com.service.khdmaa.databinding.FragmentStripeBinding;
...
//        psappLoadingViewModel = new ViewModelProvider(this,viewModelFactory).get(PSAPPLoadingViewModel.class);
    ...
    private void createTransaction() {
        ...
        if(getContext() != null) {
            ...
            stripe.get().createPaymentMethod( PaymentMethodCreateParams.create(card.toPaymentMethodParamsCard()), new ApiResultCallback<PaymentMethod>() {
                @Override
                public void onSuccess(@NonNull PaymentMethod result) {
                    progressDialog.cancel();
                    Utils.psLog(result.id);
                    close(result.id);
                }
