package com.service.khdmaa.ui.user;
...
import com.service.khdmaa.ui.item.promote.adapter.ItemPromoteHorizontalListAdapter;
...
public class ProfileFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
        ...
        binding.get().addItemButton.setOnClickListener(v -> {
            ...
            Utils.navigateOnUserVerificationActivity(userIdToVerify, loginUserId, psDialogMsg, getActivity(), navigationController, new Utils.NavigateOnUserVerificationActivityCallback() {
                ...
                public void onSuccess() {
                    navigationController.navigateToItemEntryActivity(getActivity(), Constants.ADD_NEW_ITEM, recentItemViewModel.locationId, recentItemViewModel.locationName, recentItemViewModel.locationTownshipId, recentItemViewModel.locationTownshipName);
                }
            });
    ...
    protected void initData() {
        ...
        itemViewModel.locationId = selected_location_id;
        itemViewModel.locationName = selected_location_name;
        itemViewModel.locationTownshipId = selected_township_id;
        itemViewModel.locationTownshipName = selected_township_name;

        itemViewModel.holder.location_id = itemViewModel.locationId;
        itemViewModel.holder.location_township_id = itemViewModel.locationTownshipId;
        ...
        pendingViewModel.locationId = selected_location_id;
        pendingViewModel.locationTownshipId = selected_township_id;

        pendingViewModel.holder.location_id = pendingViewModel.locationId;
        pendingViewModel.holder.location_township_id = pendingViewModel.locationTownshipId;
        ...
        rejectedViewModel.locationId = selected_location_id;
        rejectedViewModel.locationTownshipId = selected_township_id;

        rejectedViewModel.holder.location_id = rejectedViewModel.locationId;
        rejectedViewModel.holder.location_township_id = rejectedViewModel.locationTownshipId;
        ...
        disabledViewModel.locationId = selected_location_id;
        disabledViewModel.locationTownshipId = selected_township_id;

        disabledViewModel.holder.location_id = disabledViewModel.locationId;
        disabledViewModel.holder.location_township_id = disabledViewModel.locationTownshipId;
