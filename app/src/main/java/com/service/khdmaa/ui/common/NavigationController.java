package com.service.khdmaa.ui.common;
...
import com.service.khdmaa.viewobject.holder.UserParameterHolder;
...
//    }
    ...
    public void navigateToHome(MainActivity mainActivity, boolean forceReplace, String locationId, String townshipId, String townshipName, String locationName, boolean afterLogout) {
        if (checkFragmentChange(RegFragments.HOME_HOME) || forceReplace || afterLogout) {
            try {
                ...
                args.putString(Constants.SELECTED_TOWNSHIP_ID, townshipId);
                args.putString(Constants.SELECTED_TOWNSHIP_NAME, townshipName);
                fragment.setArguments(args);
...
//        Intent pickPhoto = new Intent(Intent.ACTION_PICK, android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
    ...
    public void navigateToProfileEditActivity(Activity activity) {
        ...
        activity.startActivityForResult(intent, Constants.REQUEST_CODE__EDIT_PHONE_VERIFY_ACTIVITY);
    }
    ...
    public void navigateToPhoneEditVerifyActivity(Activity activity,String number) {
        Intent intent = new Intent(activity, VerifyMobileEditActivity.class);
        intent.putExtra(Constants.USER_PHONE, number);
        activity.startActivityForResult(intent, Constants.REQUEST_CODE__EDIT_PHONE_VERIFY_ACTIVITY);
    ...
    public void navigateToEditPhoneChangeActivity(Activity activity) {
...
//        intent.putExtra(Constants.ITEM_ID, item.id);
    ...
    public void navigateToCategorySortingActivity(Activity activity) {
        Intent intent = new Intent(activity, CategorySortingListActivity.class);
        activity.startActivity(intent);
    }

    public void navigateToItemEntryActivity(Activity activity, String itemId, String locationId, String locationName, String locationTownshipId, String locationTownshipName) {
        ...
        intent.putExtra(Constants.SELECTED_TOWNSHIP_ID, locationTownshipId);
        intent.putExtra(Constants.SELECTED_TOWNSHIP_NAME, locationTownshipName);
    ...
    public void navigateToItemTownshipLocationFilterActivity(Activity activity, String keyword,String orderType,String orderBy, String selectedLocationId) {

        Intent intent = new Intent(activity, ItemTownshipLocationFilterActivity.class);
        intent.putExtra(Constants.SEARCH_CITY_INTENT_KEYWORD,keyword);
    ...
    public void navigateBackToItemTownshipLocationFragment(FragmentActivity fragmentActivity, String townshipId, String townshipName, String locationLat, String locationLng) {
        Intent intent = new Intent();
        intent.putExtra(Constants.ITEM_TOWNSHIP_TYPE_NAME, townshipName);
        intent.putExtra(Constants.ITEM_TOWNSHIP_TYPE_ID, townshipId);
        intent.putExtra(Constants.LAT, locationLat);
        intent.putExtra(Constants.LNG, locationLng);

        fragmentActivity.setResult(Constants.RESULT_CODE__SEARCH_WITH_ITEM_TOWNSHIP_TYPE, intent);
    }
    ...
    public void navigateBackToItemTownshipLocationFilterFragment(FragmentActivity activity, String keyword,String orderBy,String orderType, String selectedLocationId ){
        Intent intent = new Intent();
        intent.putExtra(Constants.SEARCH_CITY_INTENT_KEYWORD,keyword);
        intent.putExtra(Constants.SEARCH_CITY_INTENT_ORDER_TYPE,orderType);
        intent.putExtra(Constants.SEARCH_CITY_INTENT_ORDER_BY,orderBy);
    ...
    public void navigateBackToEditProfileFragment(FragmentActivity fragmentActivity, String userPhoneNo) {
        Intent intent = new Intent();

        intent.putExtra(Constants.USER_PHONE, userPhoneNo);

        fragmentActivity.setResult(Constants.RESULT_CODE__EDIT_PROFILE_ACTIITY, intent);
    }

    public void navigateBackToEditPhoneFragment(FragmentActivity fragmentActivity, String userPhoneNo) {
        Intent intent = new Intent();

        intent.putExtra(Constants.USER_PHONE, userPhoneNo);

        fragmentActivity.setResult(Constants.RESULT_CODE__EDIT_PHONE_ACTIITY, intent);
    }
    ...
    public void navigateToMainActivity(Activity activity, String selectedLocationId, String selectedLocationName, String selectedTownshipId, String selectedTownshipName, String itemId ,String lat, String lng) {
        ...
        intent.putExtra(Constants.SELECTED_TOWNSHIP_ID, selectedTownshipId);
        intent.putExtra(Constants.SELECTED_TOWNSHIP_NAME, selectedTownshipName);
        intent.putExtra(Constants.ITEM_ID, itemId);
        intent.putExtra(Constants.LAT, lat);
        intent.putExtra(Constants.LNG, lng);
    ...
    public void navigateBackToMainActivity(FragmentActivity activity, String selectedLocationId, String selectedLocationName, String selectedTownshipId, String selectedTownshipName, String lat, String lng) {
        Intent intent = new Intent(); //activity, MainActivity.class);
        intent.putExtra(Constants.ITEM_LOCATION_TYPE_ID, selectedLocationId);
        intent.putExtra(Constants.ITEM_LOCATION_TYPE_NAME, selectedLocationName);
        intent.putExtra(Constants.ITEM_TOWNSHIP_TYPE_ID, selectedTownshipId);
        intent.putExtra(Constants.ITEM_TOWNSHIP_TYPE_NAME, selectedTownshipName);
        intent.putExtra(Constants.LAT, lat);
        intent.putExtra(Constants.LNG, lng);
    ...
    public void navigateToTownshipLocationActivity(Activity activity, String flag, String locationId, String locationName, String itemId, String lat, String lng) {
        Intent intent = new Intent(activity, TownshipLocationActivity.class);
        intent.putExtra(Constants.LOCATION_FLAG, flag);
        intent.putExtra(Constants.ITEM_LOCATION_TYPE_ID, locationId);
        intent.putExtra(Constants.ITEM_LOCATION_TYPE_NAME, locationName);
        intent.putExtra(Constants.ITEM_ID, itemId);
