package com.service.khdmaa.utils;
...
public interface Constants {
    ...
    String INVALID_LAT_LNG = "0.000000";
    ...
    int REQUEST_CODE__EDIT_PHONE_VERIFY_ACTIVITY = 1032;
    ...
    int RESULT_CODE__SEARCH_WITH_ITEM_TOWNSHIP_TYPE = 2021;
    int RESULT_CODE__EDIT_PROFILE_ACTIITY = 2022;
    int RESULT_CODE__EDIT_PHONE_ACTIITY = 2023;
    ...
    String DEFAULT_CURRENCY_ID = "DEFAULT_CURRENCY_ID";
...
//    String VERIFY_EMAIL_TYPE = "VERIFY_EMAIL_TYPE";
    ...
    String FILTERING_CAT_NAME = "cat_name"; // Don't Change
    ...
    String ITEM_TOWNSHIP_TYPE = "ITEM_TOWNSHIP_TYPE";
    ...
    String ITEM_TOWNSHIP_TYPE_ID = "ITEM_TOWNSHIP_TYPE_ID";
    String ITEM_TOWNSHIP_TYPE_NAME = "ITEM_TOWNSHIP_TYPE_NAME";
    ...
    String SELECTED_TOWNSHIP_ID = "SELECTED_TOWNSHIP_ID";
    String SELECTED_TOWNSHIP_NAME = "SELECTED_TOWNSHIP_NAME";
    ...
    String SELECT_LOCATION_FROM_CITY = "SELECT_LOCATION_FROM_CITY";
