...
public class PSDialogMsg {
    ...
    public Button okButton, cancelButton, halfButton, purchaseButton, otherPaymentButton, ascButton, descButton;
    ...
    public void showSubCategoryFilterDialog(String ascText, String descText, String cancelText) {
        this.dialog.setContentView(R.layout.dialog_subcategory_filter);

        ascButton = dialog.findViewById(R.id.ascButton);
        descButton = dialog.findViewById(R.id.descButton);
        cancelButton = dialog.findViewById(R.id.cancelButton);

        ascButton.setText(ascText);
        descButton.setText(descText);
        cancelButton.setText(cancelText);
