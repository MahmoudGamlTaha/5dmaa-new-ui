...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    private void showNotification(String message,String flag) {
        ...
        if (message == null || message.equals("")) {
            ...
            displayMessage = "Welcome from 5dmaa.com";
        } else {
        ...
        i.putExtra(Constants.SELECTED_TOWNSHIP_ID ,pref.getString(Constants.SELECTED_TOWNSHIP_ID,Constants.EMPTY_STRING));
        i.putExtra(Constants.SELECTED_TOWNSHIP_NAME ,pref.getString(Constants.SELECTED_TOWNSHIP_NAME,Constants.EMPTY_STRING));
