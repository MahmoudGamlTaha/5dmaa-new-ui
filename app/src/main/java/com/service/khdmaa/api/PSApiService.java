package com.service.khdmaa.api;
...
public interface PSApiService {
    ...
    //region deleteImage
    @FormUrlEncoded
    @POST("rest/images/delete_item_image/api_key/{API_KEY}/limit/{limit}/offset/{offset}/login_user_id/{login_user_id}")
    Call<ApiStatus> deleteImage(@Path("API_KEY") String apiKey,
                                @Path("limit") String limit,
                                @Path("offset") String offset,
                                @Path("login_user_id") String login_user_id,
    ...
    @GET("rest/images/get_item_gallery/api_key/{API_KEY}/img_parent_id/{img_parent_id}/img_type/{img_type}")
...
//                                                                             @Path("offset") String offset);
    @FormUrlEncoded
    @POST("rest/subcategories/search/api_key/{API_KEY}/limit/{limit}/offset/{offset}/cat_id/{cat_id}/login_user_id/{login_user_id}")
    LiveData<ApiResponse<List<ItemSubCategory>>> getSubCategoryListWithCatId(
            @Path("API_KEY") String API_KEY,
            @Path("login_user_id") String login_user_id,
            @Path("cat_id") String catId,
            @Path("limit") String limit,
    ...
    LiveData<ApiResponse<List<Item>>> searchItem(
            ...
            @Field("item_location_township_id") String item_location_township_id,
    ...
    LiveData<ApiResponse<Image>> itemImageUpload(@Path("API_KEY") String apiKey,
                                                 ...
                                                 @Part("ordering") RequestBody ordering,
                                                 @Part MultipartBody.Part file);
    ...
    @FormUrlEncoded
    @POST("rest/categories/search/api_key/{API_KEY}/login_user_id/{login_user_id}/limit/{limit}/offset/{offset}")
...
//    );
    ...
    //region ItemTownshipLocation


    @FormUrlEncoded
    @POST("rest/item_location_townships/search/api_key/{API_KEY}/limit/{limit}/offset/{offset}/login_user_id/{loginUserId}")
    LiveData<ApiResponse<List<ItemTownshipLocation>>> getItemTownshipLocationList(
            @Path("API_KEY") String API_KEY,
            @Path("limit") String limit,
            @Path("offset") String offset,
            @Path("loginUserId") String loginUserId,
