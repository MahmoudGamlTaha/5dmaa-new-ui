...
public class ItemViewModel extends PSViewModel {
    ...
    ItemViewModel(ItemRepository repository) {
        ...
        uploadItemData = Transformations.switchMap(uploadItemObj, obj -> {
            ...
            return repository.uploadItem(obj.catId, obj.subCatId, obj.itemTypeId, obj.itemPriceTypeId, obj.itemCurrencyId, obj.conditionId, obj.locationId, obj.locationTownshipId, obj.remark,
    ...
    public void setUploadItemObj(String catId, String subCatId, String itemTypeId, String itemPriceTypeId, String itemCurrencyId, String conditionId, String locationId, String locationTownshipId,
        ...
        UploadItemTmpDataHolder tmpDataHolder = new UploadItemTmpDataHolder(catId, subCatId, itemTypeId, itemPriceTypeId, itemCurrencyId, conditionId,locationId,locationTownshipId, remark,
    ...
    class UploadItemTmpDataHolder {
        ...
        String catId, subCatId, itemTypeId, itemPriceTypeId, itemCurrencyId, conditionId, locationId, locationTownshipId, remark, description, highlightInfo, price, dealOptionId, brand, businessMode,
                isSoldOut, title, address, lat, lng,  itemId,userId;

        public UploadItemTmpDataHolder(String catId, String subCatId, String itemTypeId, String itemPriceTypeId, String itemCurrencyId, String conditionId, String locationId, String locationTownshipId, String remark, String description, String highlightInfo, String price, String dealOptionId, String brand, String businessMode, String isSoldOut, String title, String address, String lat, String lng, String itemId, String userId) {
            this.catId = catId;
