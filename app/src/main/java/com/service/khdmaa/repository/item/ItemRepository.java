package com.service.khdmaa.repository.item;
...
//                        }
                        ...
                        for (int i = 0; i < itemList.size(); i++) {
                            db.itemMapDao().insert(new ItemMap(mapKey + itemList.get(i).id, mapKey, itemList.get(i).id,  itemList.get(i).addedUserId, itemList.get(i).defaultPhoto.imgId, i + 1, dateTime));
                        }
                    });
                } catch (Exception ex) {
                    Utils.psErrorLog("Error at ", ex);
...
//                }
            ...
            protected LiveData<ApiResponse<List<Item>>> createCall() {
                ...
                return psApiService.searchItem(Config.API_KEY, limit, offset, loginUserId, itemParameterHolder.keyword, itemParameterHolder.cat_id, itemParameterHolder.sub_cat_id,
                        ...
                        itemParameterHolder.location_id, itemParameterHolder.location_township_id, itemParameterHolder.deal_option_id, itemParameterHolder.condition_id, itemParameterHolder.max_price,
                    ...
                    appExecutors.diskIO().execute(() -> {
                        ...
                        try {
                            db.runInTransaction(() -> {
                                ...
                                for (int i = 0; i < response.body.size(); i++) {
                                    db.itemMapDao().insert(new ItemMap(mapKey + response.body.get(i).id, mapKey, response.body.get(i).id, response.body.get(i).addedUserId, response.body.get(i).defaultPhoto.imgId, startIndex + i, dateTime));
                                }
...
//                    }
    ...
    public LiveData<Resource<Image>> uploadItemImage( String filePath,Uri uri, String imageId, String
            itemId, String ordering, ContentResolver contentResolver) {
        //Init File
        ...
        RequestBody orderingIdRB =
                RequestBody.create(
                        MediaType.parse("multipart/form-data"), ordering);
        ...
        return new NetworkBoundResource<Image, Image>(appExecutors) {
            ...
            protected LiveData<ApiResponse<Image>> createCall() {
                ...
                return psApiService.itemImageUpload(Config.API_KEY, idRB, imgIdRB, orderingIdRB, finalBody);
            }
    ...
    public LiveData<Resource<Item>> uploadItem(String catId, String subCatId, String
            itemTypeId, String itemPriceTypeId, String itemCurrencyId, String conditionId, String
                                                       locationId, String locationTownshipId, String remark,
        ...
        appExecutors.networkIO().execute(() -> {
            ...
            try {
                ...
                response = psApiService.itemUpload(Config.API_KEY, catId, subCatId, itemTypeId, itemPriceTypeId, itemCurrencyId, conditionId, locationId, locationTownshipId, remark,
