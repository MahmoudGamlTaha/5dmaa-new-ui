...
public class PSAppInfo {
    ...
    @Embedded(prefix = "default_currency_")
    ...
    public String offlineEnabled;

    @SerializedName("razor_key")
    public String razorKey;

    public PSAppInfo(@NonNull String id, PSAppVersion psAppVersion, PSAppSetting psAppSetting, PSUserInfo userInfo, ItemCurrency itemCurrency, String oneDay, String currencySymbol, String currencyShortForm, String stripePublishableKey, String payStackKey, String inAppPurchasedEnabled, String inAppPurchasedPrdIdAndroid, String payStackEnabled, String paypalEnabled, String stripeEnabled,String razorEnabled, String offlineEnabled, String razorKey) {
        this.id = id;
