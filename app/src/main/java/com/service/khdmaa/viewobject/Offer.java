...
import com.google.gson.annotations.SerializedName;
    ...
    public class Offer {
        ...
        public Offer(@NonNull String id, String itemId, String buyerUserId, String sellerUserId, String negoPrice, String buyerUnreadCount, String sellerUnreadCount, String addedDate, Item item, User buyerUser, User sellerUser, String addedDateStr, String isOffer, String isAccept, String offerAmount) {
            this.id = id;
            this.itemId = itemId;
