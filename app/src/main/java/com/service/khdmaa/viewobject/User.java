...
public class User {
    ...
    public User(@NonNull String userId, String userIsSysAdmin, String isCityAdmin, String facebookId, String phoneId, String googleId, String userName, String userEmail, String userPhone, String userAddress, String city, String userPassword, String userAboutMe, String isShowEmail, String isShowPhone, String userCoverPhoto, String userProfilePhoto, String roleId, String status, String isBanned, String addedDate, String deviceToken, String code, String overallRating, String whatsapp, String messenger, String followerCount, String followingCount, String isFollowed, String added_date_str, String verifyTypes, String emailVerify, String facebookVerify, String googleVerify, String phoneVerify, String ratingCount, RatingDetail ratingDetails) {
        this.userId = userId;
