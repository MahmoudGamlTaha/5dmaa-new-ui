package com.service.khdmaa.viewobject;
...
public class Item {
    ...
    @Embedded(prefix = "item_location_township_")
    @SerializedName("item_location_township")
    public final ItemTownshipLocation itemTownshipLocation;
    ...
    public Item(@NonNull String id, String catId, String subCatId, String itemTypeId, String itemPriceTypeId, String itemCurrencyId, String conditionOfItem, String description, String highlightInfo, String price, String dealOptionId, String brand, String businessMode, String isSoldOut, String title, String address, String lat, String lng, String status, String addedDate, String addedUserId, String updatedDate, String updatedUserId, String updatedFlag, String touchCount, String favouriteCount, String addedDateStr, String photoCount, String dealOptionRemark, Image defaultPhoto, Image defaultIcon, ItemCategory category, ItemSubCategory subCategory, ItemType itemType, ItemPriceType itemPriceType, ItemCurrency itemCurrency, ItemLocation itemLocation, ItemTownshipLocation itemTownshipLocation, ItemCondition itemCondition, ItemDealOption itemDealOption, User user, String isOwner, String isFavourited, String isPaid,String dynamicLink, String paidStatus) {
        ...
        this.itemTownshipLocation = itemTownshipLocation;
