package com.service.khdmaa.viewobject.holder;
...
public class ItemParameterHolder implements Serializable {
    ...
    public String keyword, cat_id, sub_cat_id,type_id,price_type_id,condition_id,deal_option_id,currency_id,location_id, location_township_id,
    ...
    public String getItemMapKey(){
        ...
        if (!location_township_id.isEmpty()) {
            result += location_township_id + ":";
        }
